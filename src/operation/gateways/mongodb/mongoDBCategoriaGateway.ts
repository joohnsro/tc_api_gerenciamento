...
export default class MongoDBCategoriaGateway implements CategoriaGatewayInterface {
    ...
    async atualizarCategoria(produtoDTO: CategoriaDTO): Promise<Categoria> {
        const resposta = await this.dataSource.atualizarCategoria(produtoDTO)
